                                        ...
                                        <div class="row">  
                                            <div class="col-md-6 pr-0">
                                                <div class="form-group form-group-default">
                                                    ...
                                                    <input name="tendianhac" type="text" class="form-control" value="<?php echo $arr['tendianhac']?>" required="required">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 pr-0">
                                                <div class="form-group form-group-default">
                                                    <label>Giá</label>
                                                     <input name="gia" type="number" class="form-control" value="<?php echo $arr['gia']?>" required="required">
                                                </div>
                                            </div>
                                            <div class="col-md-6 pr-0">
                                                <div class="form-group form-group-default"> 
                                                <input type="hidden" name="img" value="<?php echo $arr['hinh']?>">        
