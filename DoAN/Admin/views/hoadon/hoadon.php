                                        ...
                                        <table id="add-row" class="display table table-striped table-hover" >
                                            ...
                                            <tbody>
                                                   <?php
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $arr['id_hd'];?></td>
                                                        <td><?php echo $arr['email'];?></td>
                                                        <td><?php echo $arr['tennguoinhan'];?></td>
                                                        <td><?php echo chuyentien($arr['tongtien']);?></td> 
                                                         <td>
                                                            <div class="form-button-action">
                                                                <button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Remove"> <a href='index.php?controller=hoadoncontroller&action=chitiet&id=<?php echo $arr['id_hd'] ?>'>
                                                                    Chi tiết</a>
                                                                </button>
