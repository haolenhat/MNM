                                        ...
                                        <div class="row">  
                                            <div class="col-md-6 pr-0">
                                                <div class="form-group form-group-default">
                                                    ...
                                                    <input name="tennhac" type="text" class="form-control" value="<?php echo $arr['tennhac']?>" required="required">
                                                </div>
                                            </div>
                                            <div class="col-md-6 pr-0">
                                                <div class="form-group form-group-default">
                                                    <label>Tác giả</label>
                                                    <input name="tentacgia" type="text" class="form-control" value="<?php echo $arr['tentacgia']?>" required="required">
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6 pr-0">
                                                    <div class="form-group form-group-default">
                                                        <label>Video</label>
                                                        <input type="hidden" name="video" value="<?php echo $arr['video']?>">
                                                        <input multiple type="file" name ="video_new" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
