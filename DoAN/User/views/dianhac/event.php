                        ...
                        <?php
                         ...
                         foreach($data as $r)
                         {
                           ...
                           <div class="col-md-3 col-sm-6">
                                <div class="products">
                                 <div class="thumbnail"><a href="index.php?controller=sanpham&action=sua&id=<?php echo $r['id_dianhac']?>"><img src="../admin/views/assets/img/<?php echo $r['hinh'] ?>"  style="width:150px;height:220px" alt="Product Name" ></a></div>
                                 <div class="productname"><?php echo $r['tendianhac'] ?></div>
                                 <h4 class="price"><?php echo chuyentien( $r['gia'] )?></h4>
